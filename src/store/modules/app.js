...
const app = {
  state: {
    ...
    apikeyAccount: sessionStorage.getItem('apikey_account') || ''
  },
  mutations: {
    ...
    SET_APIKEYACCOUNT: (state, apikeyAccount) => {
      state.apikeyAccount = apikeyAccount
      sessionStorage.setItem('apikey_account', apikeyAccount)
    },
  ...
  actions: {
    ...
    setApikeyAccount ({
      ...
      commit('SET_APIKEYACCOUNT', apikeyAccount)
    },
    setMetaNetworkId ({
      commit
    }, networkID) {
